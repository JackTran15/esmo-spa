...
export const MainHero = () => {
  return (
    <div className="w-full max-w-[800px] mx-auto pt-[32px] md:pt-[48px]">
      <div className="text-title_4 md:text-title_1 md:text-center font-medium text-noto">
      ...
      <div className="w-full flex flex-col md:flex-row mt-[32px] md:mt-[24px] gap-[16px] justify-center">
        <Link href="/contact">
